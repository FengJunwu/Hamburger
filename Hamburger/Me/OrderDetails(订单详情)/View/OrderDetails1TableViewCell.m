...
#import "OrderModel.h"
@interface OrderDetails1TableViewCell ()
...
@end
@implementation OrderDetails1TableViewCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.contentView sd_addSubviews:@[titleLabel,stateLabel,bgView1,img1,priceLabel1,nameLabel1,numLabel1,integralLabel,qisiLabel,addLabel,bgView2,img2,nameLabel2,priceLabel2,numLabel2,integralLabel2,tag1,tag2,bottomLabel,lineView,button1,bottonView]];
