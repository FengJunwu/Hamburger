//
//  HamburgerDetailsViewController.m
//  Hamburger
//
...
#import "HamburgerDetailsViewController.h"
#import "XRCarouselView.h"
#import "HamburgerDetailsTableViewCell.h"
#import "ShoppingCartViewController.h"//购物车
@interface HamburgerDetailsViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;

@property (nonatomic, strong) XRCarouselView *carouselView;
@end

@implementation HamburgerDetailsViewController
...
-(void)configBanner{
     ...
     *  通过代码创建
     */
    UIImage *image = [UIImage imageNamed:@"商品详情banner"];
...
//    _carouselView.placeholderImage = [UIImage imageNamed:@"商品详情banner"];
    _carouselView.imageArray = [NSMutableArray arrayWithArray:@[[UIImage imageNamed:@"商品详情banner"]]];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    HamburgerDetailsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
    if (!cell) {
        cell = [[HamburgerDetailsTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
    return cell;
}
